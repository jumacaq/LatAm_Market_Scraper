# FILE: job-market-intelligence3 - copia - copia/job-market-intelligence/scrapers/spiders/linkedin_spider.py
import scrapy
...
class LinkedInSpider(scrapy.Spider):
    ...
    def errback_httpbin(self, failure):
        self.logger.error(f"❌ Request fallido: {failure.value.response.status} - {failure.request.url}")